...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-240,-240},
        ...
        Rectangle(
          ...
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led11.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-170,230},{-130,190}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led12.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-110,230},{-70,190}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led13.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-50,230},{-10,190}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led14.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{10,230},{50,190}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led15.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{70,230},{110,190}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led16.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{130,230},{170,190}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led17.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{190,230},{230,190}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led18.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-230,170},{-190,130}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led21.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-170,170},{-130,130}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led22.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-110,170},{-70,130}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led23.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-50,170},{-10,130}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led24.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{10,170},{50,130}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led25.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{70,170},{110,130}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led26.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{130,170},{170,130}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led27.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{190,170},{230,130}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led28.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-230,110},{-190,70}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led31.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-170,110},{-130,70}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led32.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-110,110},{-70,70}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led33.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-50,110},{-10,70}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led34.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{10,110},{50,70}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led35.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{70,110},{110,70}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led36.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{130,110},{170,70}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led37.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{190,110},{230,70}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led38.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-230,50},{-190,10}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led41.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-170,50},{-130,10}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led42.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-110,50},{-70,10}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led43.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-50,50},{-10,10}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led44.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{10,50},{50,10}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led45.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{70,50},{110,10}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led46.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{130,50},{170,10}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led47.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{190,50},{230,10}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led48.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-230,-10},{-190,-50}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led51.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-170,-10},{-130,-50}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led52.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-110,-10},{-70,-50}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led53.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-50,-10},{-10,-50}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led54.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{10,-10},{50,-50}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led55.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{70,-10},{110,-50}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led56.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{130,-10},{170,-50}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led57.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{190,-10},{230,-50}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led58.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-230,-70},{-190,-110}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led61.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-170,-70},{-130,-110}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led62.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-110,-70},{-70,-110}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led63.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-50,-70},{-10,-110}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led64.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{10,-70},{50,-110}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led65.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{70,-70},{110,-110}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led66.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{130,-70},{170,-110}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led67.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{190,-70},{230,-110}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led68.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-230,-130},{-190,-170}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led71.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-170,-130},{-130,-170}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led72.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-110,-130},{-70,-170}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led73.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-50,-130},{-10,-170}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led74.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{10,-130},{50,-170}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led75.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{70,-130},{110,-170}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led76.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{130,-130},{170,-170}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led77.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{190,-130},{230,-170}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led78.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-230,-190},{-190,-230}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led81.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-170,-190},{-130,-230}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led82.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-110,-190},{-70,-230}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led83.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{-50,-190},{-10,-230}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led84.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{10,-190},{50,-230}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led85.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{70,-190},{110,-230}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led86.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{130,-190},{170,-230}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led87.mean.y > 0 then {255,40,40} else {240,240,240}),
          fillPattern=FillPattern.Solid),
                                          Ellipse(
          extent={{190,-190},{230,-230}},
          pattern=LinePattern.None,
          lineColor={0,0,0},
          fillColor=DynamicSelect({240,240,240}, if led88.mean.y > 0 then {255,40,40} else {240,240,240}),
