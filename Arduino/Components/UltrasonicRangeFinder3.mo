...
equation
  ...
  connect(idealCommutingSwitch.p, idealClosingSwitch.n)
    annotation (Line(points={{-18,40},{-38,40}}, color={0,0,255}));

  connect(idealClosingSwitch.p, sigPin)
    annotation (Line(points={{-58,40},{-100,40}}, color={0,0,255}));
  ...
  connect(delayedPulse1.y, idealClosingSwitch.control) annotation (Line(points={{79,70},
          {14,70},{-48,70},{-48,47}},         color={255,0,255}));
  ...
  connect(not2.u, idealClosingSwitch.control) annotation (Line(points={{78,94},
          {60,94},{60,70},{-48,70},{-48,47}},color={255,0,255}));
  ...
  connect(idealCommutingSwitch.n1, vPin) annotation (Line(points={{2,45},{12,45},
          {12,46},{20,46},{20,0},{-100,0}}, color={0,0,255}));
  connect(idealCommutingSwitch.n2, gndPin) annotation (Line(points={{2,40},{12,
          40},{12,-40},{-100,-40}}, color={0,0,255}));
